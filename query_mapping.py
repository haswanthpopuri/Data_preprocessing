...
csvfile=open('filtered_data.csv','r')
...
for pid in querys:
        ...
        address='/blue/djlemas/haswanthpopuri/Data_Processing/PPDbench/reconstructed_peptides/'+pdbid+'.pdb'#receptor.pdb
...
with open('query_peptide_sequence_index.txt','w') as f3:      
